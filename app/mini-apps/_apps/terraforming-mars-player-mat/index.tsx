...
/* ── Resource definitions with game-accurate colors ── */
...
function PlantIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
      ...
      />
      <path
        d="M12 12C12 8 8 4 4 4c0 4 4 8 8 8z"
        fill="#4CAF50"
        opacity={0.3}
        stroke="#4CAF50"
        strokeWidth="1.5"
      ...
      />
      <path
        d="M12 15c0-3 3-6 6-6-1 3-3 6-6 6z"
        fill="#66BB6A"
        opacity={0.3}
        stroke="#66BB6A"
        strokeWidth="1.5"
...
function HeatIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
      <path
        d="M12 23c-4 0-7-3-7-7 0-3 3-5 5-8 1-1.5 2-3 2-6 0 3 1 4.5 2 6 2 3 5 5 5 8 0 4-3 7-7 7z"
        fill="#FF5722"
        opacity={0.3}
        stroke="#FF7043"
        strokeWidth="1.5"
...
function MarsHorizon() {
  return (
    <svg
      ...
      className="absolute bottom-0 left-0 w-full h-28 opacity-40 pointer-events-none"
    >
      <defs>
      ...
      <path
        d="M0 80 Q50 50 100 70 Q150 90 200 60 Q250 30 300 65 Q350 85 400 55 L400 120 L0 120Z"
        fill="url(#marsGrad)"
      />
      <path
        d="M0 95 Q80 75 160 90 Q240 105 320 80 Q370 70 400 85 L400 120 L0 120Z"
        fill="#8B2F0A"
        opacity="0.3"
      />
    </svg>
...
function StarField() {
  ...
  return (
    <svg
      viewBox="0 0 400 60"
      preserveAspectRatio="none"
      className="absolute top-0 left-0 w-full h-16 opacity-60 pointer-events-none"
    >
      {stars.map((s, i) => (
        <circle
          key={i}
...
function MarsPlanet() {
  return (
    <svg
      viewBox="0 0 80 80"
      className="absolute -top-4 -right-4 w-24 h-24 opacity-15 pointer-events-none"
    >
...
function Stepper({
  ...
  return (
    <div className="flex items-center gap-0.5">
      <button
        onClick={onDec}
        className={`${btnClass} bg-white/[0.07] active:bg-white/[0.15] text-white/70 active:text-white font-bold transition-all active:scale-95 select-none`}
      >
        −
      </button>
      <span className={valClass} style={{ color }}>
        {value}
      </span>
      <button
        onClick={onInc}
...
export default function TerraformingMarsPlayerMat() {
  ...
  return (
    <div className="relative overflow-hidden bg-[#0C0C14] text-white min-h-[480px]">
      <style>{`
      ...
      <div className="relative z-10 px-4 pt-5 pb-6">
        ...
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <div className="flex flex-col items-center">
                <span className="text-[10px] font-semibold uppercase tracking-widest text-orange-300/70 mb-1">
                  TR
                </span>
                <Stepper
                  value={terraformRating}
                  onDec={() =>
                    setTerraformRating((p) => Math.max(0, p - 1))
                  }
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-2xl font-bold tabular-nums text-orange-200/90 h-10 flex items-center">
                {generation}
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`relative px-4 py-2.5 rounded-xl text-sm font-bold text-white overflow-hidden transition-all active:scale-95 select-none ${
                isProducing
                  ? "opacity-70"
              ...
              style={{
                background:
                  "linear-gradient(135deg, #C0440F 0%, #E05A20 100%)",
              }}
            >
            ...
            <button
              onClick={reset}
              className="w-10 h-10 rounded-xl bg-white/[0.07] active:bg-white/[0.12] text-white/50 active:text-white/80 flex items-center justify-center transition-all active:scale-95 select-none"
          ...
          {RESOURCES.map((r) => {
            ...
            return (
              <div
                ...
                style={{
                  backgroundColor: r.darkHex,
                  borderColor: `${r.hex}22`,
                }}
              >
                {/* Resource header */}
        ...
        <p className="mt-4 text-[11px] text-white/25 text-center leading-relaxed">
          Produce: Energy stock → Heat, then add production to each
          resource.
        </p>
      </div>
    </div>
